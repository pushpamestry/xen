 ...
 * => commit 6e13b64c6badc5cb0958aa5040fe231b4c0760f3 (not in mainline yet)
...
static inline int __must_check ipmmu_vmsa_map_page(struct domain *d,
		unsigned long gfn, unsigned long mfn, unsigned int flags)
{
...
static inline int __must_check ipmmu_vmsa_unmap_page(struct domain *d,
		unsigned long gfn)
{
